    ...
    <div className="min-h-screen bg-wp-bg pt-24 pb-20 px-6">
      <div className="max-w-2xl mx-auto prose prose-sm">
        ...
        <p className="text-wp-text2 leading-relaxed">
          Webflott GbR (Bastian Saupe & Philip Lindner), 06667 Weißenfels. Kontakt: kontakt@waermepumpenbegleiter.de
        </p>
        ...
        <p className="text-wp-text2 leading-relaxed">
          ...
          und Widerspruch. Kontakt: kontakt@waermepumpenbegleiter.de. Beschwerden können Sie bei der zuständigen
