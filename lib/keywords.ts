...
export const KEYWORDS: Keyword[] = [
  // ── TIER 1 — Höchste Priorität ────────────────────────────────
  {
    ...
    metaTemplate: 'Wärmepumpe in {stadt} einbauen ✓ Kosten ab {preisVon} ✓ Bis 70% KfW-Förderung ✓ Geprüfte Installateure ✓ Kostenlos vergleichen.',
  ...
  },
  {
    ...
    metaTemplate: 'Was kostet eine Wärmepumpe in {stadt}? ✓ Aktuelle Preise {year} ✓ Stadtspezifische Betriebskosten ✓ Bis 70% Förderung ✓ Kostenlos vergleichen.',
  ...
  },
  {
    ...
    metaTemplate: 'Geprüfte Wärmepumpen-Installateure in {stadt} ✓ Lokale Meisterbetriebe ✓ Kostenlos bis zu 3 Angebote ✓ Alle Betriebe HWK-geprüft.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe Förderung {stadt} {year}: Bis 70% KfW-Zuschuss + {bundesland}-Förderung ✓ Förderrechner ✓ Schritt-für-Schritt Anleitung.',
  ...
  },
  {
    ...
    metaTemplate: 'Luft-Wasser-Wärmepumpe {stadt} ✓ JAZ {jaz} bei {avgTemp}°C Jahresmittel ✓ Kosten & Förderung ✓ 92% Marktanteil ✓ Geprüfte Installateure.',
  ...
  // ── TIER 2 ────────────────────────────────────────────────────
  {
    ...
    metaTemplate: 'Wärmepumpe kaufen in {stadt} ✓ Kaufberater {year} ✓ Welche WP ist die richtige? ✓ Bis 70% KfW-Förderung ✓ Kostenlose Angebote.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe im Altbau {stadt} ✓ Eignung & Voraussetzungen ✓ Heizlast-Rechner ✓ Hydraulischer Abgleich ✓ Geprüfte Installateure.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe nachrüsten in {stadt} ✓ GEG-Fristen {year} ✓ Bestandsgebäude umrüsten ✓ Hydraulischer Abgleich ✓ Förderung bis €21.000.',
  ...
  },
  {
    ...
    metaTemplate: 'Heizung tauschen {stadt} {year} ✓ WP vs. Gas vs. Pellet im Vergleich ✓ GEG-Pflicht ab {year} ✓ Kostenlos alle Optionen vergleichen.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe Installation {stadt} ✓ Ablauf & Zeitplan ✓ Genehmigungen in {stadt} ✓ Geprüfte Installateure ✓ Kosten & Förderung.',
  ...
  },
  {
    ...
    metaTemplate: 'Kommunale Wärmeplanung {stadt}: Fristen, Pflichten & was das für Ihre Heizung bedeutet ✓ GEG {year} ✓ Wärmeplan {stadt} erklärt.',
  ...
  // ── TIER 3 ────────────────────────────────────────────────────
  {
    ...
    metaTemplate: 'Erdwärmepumpe in {stadt} ✓ Geologische Eignung ✓ Sole-Wasser & Wasser-Wasser ✓ Kosten & Förderung ✓ Lokale Experten.',
  ...
  },
  {
    ...
    metaTemplate: 'Kostenloses Wärmepumpe Angebot in {stadt} ✓ Bis zu 3 geprüfte Fachbetriebe ✓ Vergleichen & sparen ✓ Jetzt unverbindlich anfragen.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe Preise {stadt} {year} ✓ Alle Typen im Vergleich ✓ Luft-Wasser ab {preisVon} ✓ Aktuelle Marktpreise ✓ Förderung bis €21.000.',
  ...
  },
  {
    ...
    metaTemplate: 'Geprüfte Wärmepumpen-Anbieter in {stadt} ✓ Lokale Meisterbetriebe ✓ Hersteller-Vergleich ✓ Kostenlos Angebote einholen.',
  ...
  },
  {
    ...
    metaTemplate: 'Luftwärmepumpe {stadt} ✓ Luft-Luft & Luft-Wasser ✓ JAZ {jaz} für {stadt} ✓ Kosten & Förderung ✓ Stadtspezifische Effizienz.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe im Neubau {stadt} ✓ GEG-Pflicht seit 2024 ✓ Optimale Planung ✓ Sole-Wasser empfohlen ✓ Kosten & Förderung.',
  ...
  // ── TIER 4 ────────────────────────────────────────────────────
  {
    ...
    metaTemplate: 'Kostenlose Wärmepumpen-Beratung {stadt} ✓ Unabhängig & herstellerneutral ✓ iSFP-Förderung ✓ Energieberatung vor Ort.',
  ...
  },
  {
    ...
    metaTemplate: 'Zertifizierte WP-Fachbetriebe in {stadt} ✓ Meisterbetriebe ✓ HWK-eingetragen ✓ BWP-Mitglieder ✓ Kostenlos anfragen.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe Montage {stadt} ✓ Aufstellort & Lärmschutz ✓ Montageablauf erklärt ✓ Genehmigungen in {bundesland} ✓ Lokale Fachbetriebe.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe oder Gas in {stadt}? ✓ Ehrlicher Kostenvergleich {year} ✓ CO₂-Preis 2030 berücksichtigt ✓ Stadtspezifische Berechnung.',
  ...
  },
  {
    ...
    metaTemplate: 'Wärmepumpe Stromverbrauch {stadt} ✓ Berechnung mit {strompreis} ct/kWh ✓ JAZ {jaz} in {stadt} ✓ Optimierungstipps ✓ Kostenrechner.',
