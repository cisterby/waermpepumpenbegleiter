// FachbetriebTemplate — waermepumpe-fachbetrieb
'use client';
...
export default function FachbetriebTemplate({ city, keyword, calc, foerd, jaz, nearby, h1 }: CityPageRouterProps) {
  ...
  const sections = (
    <>
      ...
      {/* WP-Fachbetrieb — Tabellen */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">WP-Fachbetrieb in {city.name} — Zahlen 2026</h2>
