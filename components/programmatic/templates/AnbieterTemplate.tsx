// AnbieterTemplate — waermepumpe-anbieter
'use client';
...
export default function AnbieterTemplate({ city, keyword, calc, foerd, jaz, nearby, h1 }: CityPageRouterProps) {
  ...
  const sections = (
    <>
      ...
      {/* Wärmepumpen-Anbieter — Tabellen */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">Wärmepumpen-Anbieter in {city.name} — Zahlen 2026</h2>
