// StromverbrauchTemplate — waermepumpe-stromverbrauch
'use client';
...
export default function StromverbrauchTemplate({ city, keyword, calc, foerd, jaz, nearby, h1 }: CityPageRouterProps) {
  ...
  const sections = (
    <>
      ...
      {/* WP Stromverbrauch — Tabellen */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">WP Stromverbrauch in {city.name} — Zahlen 2026</h2>
