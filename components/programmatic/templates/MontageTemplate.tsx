// MontageTemplate — waermepumpe-montage
'use client';
    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <h3 className="font-heading font-bold text-wp-text text-lg">WP-Montage in {city.name}</h3>
          {[
      ...
      {/* WP-Montage — Tabellen */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">WP-Montage in {city.name} — Zahlen 2026</h2>
