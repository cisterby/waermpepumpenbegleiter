// VergleichTemplate — waermepumpe-oder-gas
'use client';
    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <h3 className="font-heading font-bold text-wp-text text-lg">WP oder Gas Vergleich in {city.name}</h3>
          {[
      ...
      {/* WP oder Gas Vergleich — Tabellen */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">WP oder Gas Vergleich in {city.name} — Zahlen 2026</h2>
