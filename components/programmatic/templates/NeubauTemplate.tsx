// NeubauTemplate — waermepumpe-neubau — maximale Uniqueness
'use client';
...
export default function NeubauTemplate({ city, keyword, calc, foerd, jaz, nearby, h1, allCities }: CityPageRouterProps) {
    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div className="relative rounded-2xl overflow-hidden h-64">
          <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=900&q=80" alt={h1} className="w-full h-full object-cover" />
        ...
        <div className="space-y-3">
          <h3 className="font-heading font-bold text-wp-text text-lg">Wärmepumpe Neubau in {city.name}</h3>
          {[
      ...
      {/* Neubau-Besonderheiten — volles Fließtext */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">Neubau-Besonderheiten in {city.name} — was wichtig ist</h2>
        <div className="space-y-4 text-wp-text2 leading-relaxed">
          ...
          <div className="bg-wp-greenlt border border-wp-green3/30 rounded-xl p-5">
            <h3 className="font-heading font-semibold text-wp-green text-base mb-2">GEG + PV-Kombination in {city.name}</h3>
      ...
      <div className="relative rounded-2xl overflow-hidden">
        <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=900&q=80" alt={`${keyword.keyword.replace('[Stadt]', city.name)}`} className="w-full h-52 object-cover" />
  ...
  return (
    <RichTemplateBase
      ...
      heroImg="https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=1920&q=80"
      heroStats={heroStats}
