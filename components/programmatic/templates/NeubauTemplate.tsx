// NeubauTemplate — waermepumpe-neubau
'use client';
...
export default function NeubauTemplate({ city, keyword, calc, foerd, jaz, nearby, h1 }: CityPageRouterProps) {
  ...
  const sections = (
    <>
      ...
      {/* Wärmepumpe Neubau — Tabellen */}
      <div>
        <h2 className="font-heading font-bold text-wp-text text-2xl mb-4">Wärmepumpe Neubau in {city.name} — Zahlen 2026</h2>
